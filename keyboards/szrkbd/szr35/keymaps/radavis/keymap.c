...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_split_3x5_3(
    ...
    KC_LCTL, KC_TILD, XXXXXXX, XXXXXXX, KC_LBRC,      KC_RBRC, KC_MINS, KC_EQL,  KC_PIPE, KC_DQT,
                      XXXXXXX, XXXXXXX, KC_CUT,       KC_PSTE, XXXXXXX, KC_DEL
  ),
  [_RAISE] = LAYOUT_split_3x5_3(
    ...
    KC_LCTL, KC_GRV,  KC_LGUI, KC_LALT, XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX, KC_BSLS, KC_QUOT,
                      KC_DEL,  XXXXXXX, KC_RALT,      RM_TOGG, XXXXXXX, RM_NEXT
  ),
